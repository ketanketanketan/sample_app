...
describe User do
  ...
  it "should reject invalid email addresses" do
    addresses = %w[user@foo,com user_alt_foo.org example.user@foo.]
    addresses.each do |address|
  ...
  it "should reject duplicate email addresses" do 
    User.create(@attr) # Put a user with given email address into the database.
  ...
  describe "micropost associations" do
    ...
    it "should destroy associated microposts" do
      ...
      # we use find_by_id() because find() raises an execption on failure
      # we coul use find if we wrote the following
      #
      # lambda do
      #   Microposts.find(micropost.id)
  ...
  describe "relationships" do
    ...
    it "should respond to relationship method" do
